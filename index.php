        ...
        <div class="row">
          <div class="col-md-5 col-md-push-7">
            <div class="banner_content">
              ...
              <a href="about-us.php?type=aboutus" class="btn">More Info <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        <h2>Find the Best <span>Bicycle For You</span></h2>
        <p>When you are on a ride, there are many roads to cross, but only one companion along the way.</p>
      </div>
      <div class="row">
        ...
        <div class="recent-tab">
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#resentnewbike" role="tab" data-toggle="tab">New Bicycle</a></li>
          </ul>
        </div>
                  ...
                  <div class="recent-bike-list">
                    <div class="bike-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" class="img-responsive" alt="image"></a>
                      <ul>
                        ...
                        <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear); ?> Year</li>
  ...
  <section class="section-padding testimonial-section parallex-bg">
    <div class="container div_zindex">
      <div class="section-header white-text text-center">
        <h2>Clients<span> We Satisfy</span></h2>
      </div>
      <div class="row">
