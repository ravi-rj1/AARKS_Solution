...
<head>
  ...
  <title>Bicycle Rental | Bicycle Details</title>
  <!--Bootstrap -->
        ...
        <div class="container">
              ...
              <div class="main_features">
                <ul>
                  ...
                  <li> <i class="fa fa-check" aria-hidden="true"></i>
                    <h5><?php echo htmlentities($result->Position); ?></h5>
                    <p>Status</p>
                  </li>
              ...
              <div class="listing_more_info">
                <div class="listing_detail_wrap">
                  ...
                  <ul class="nav nav-tabs gray-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Product Details</a></li>
              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  <div class="form-group">
                    <p><i aria-hidden="true"></i>From Date</p>
                    <input type="datetime-local" class="form-control" name="fromdate" required>
                  </div>
                  <div class="form-group">
                    <p><i aria-hidden="true"></i>To Date</p>
                    <input type="datetime-local" class="form-control" name="todate" required>
                  </div>
                  <div class="form-group">
                    <p><i aria-hidden="true"></i>Message</p>
                    <textarea rows="4" class="form-control" name="message" placeholder="Post your concerns here..." required></textarea>
                  </div>
          ...
          <div class="similar_bikes">
            ...
            <div class="row">
              <?php
              $bid = $_SESSION['brndid'];
              $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.Position,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.Quantity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:bid";
              $query = $dbh->prepare($sql);
